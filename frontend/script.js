...
async function fetchAndDisplayBlogPosts(){
    try{
        ...
        console.error('Error fetch content', error.message);
    }
}
...
async function displayBlogPost(blogPosts) {
    ...
    function createLikeButton(likes) {
        ...
        thumb.classList.add('thumb-icon');
        thumb.src = 'resources/thumb.jpg';
        thumb.alt = 'Like';
    ...
    function createCommentsElement(blogPost) {
        ...
        blogPost.comments.forEach((comment,index) => {
            ...
            userIcon.classList.add('thumb-icon');
